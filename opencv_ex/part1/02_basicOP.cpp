...
cv::String folderPath = "/home/chan/chanpark-opencv-2026/data";
...
int main() {
    ...
    Point p4(1,2); // Point_<int>의 typedef
    Point2i p5(3,4); // Point_<int>의 typedef
    Point2f p6(3.11, 2.11); // Point_<float>의 typedef
